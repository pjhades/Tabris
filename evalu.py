...
def analyze_lambda(exp):
    ...
    def f(env):
        # if (lambda a (...)), to_python_list() will fail
        return trampoline.fall(Procedure(to_python_list(params), body, env))
...
def analyze_exp(exp):
    ...
    #    return trampoline.boucne(analyze_assignment, exp)
